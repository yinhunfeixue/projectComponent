...
exports.default = exports.EditType = void 0;
...
var TreeCurd = /*#__PURE__*/function (_Component) {
  ...
  function TreeCurd() {
    ...
    _this.defaultRenderOptItem = function (extraData) {
      ...
      }, "\u65B0\u589E"), selectedKeys && selectedKeys.length > 0 && /*#__PURE__*/_react.default.createElement(_ConfirmButton.default, {
        modalContent: {
          title: '这个操作不可逆',
          content: /*#__PURE__*/_react.default.createElement("span", null, "\u786E\u5B9A\u8981", /*#__PURE__*/_react.default.createElement("span", {
            style: {
              color: 'red'
            }
          }, "\u5220\u9664"), "\u8BE5\u8282\u70B9\uFF1F")
  ...
  _createClass(TreeCurd, [{
    ...
    value: function render() {
      ...
      }, editEnable ? renderExtra ? renderExtra(this.getExtraData(), this.defaultRenderOptItem) : this.defaultRenderOptItem(this.getExtraData()) : null), /*#__PURE__*/_react.default.createElement("div", {
      ...
      }, showSearch !== undefined && /*#__PURE__*/_react.default.createElement("div", {
        style: {
          marginBottom: 20
        }
      ...
      }, _AntdUtil.default.rendeTree(treeData, TreeProps, getKey, getTitle, getChildren, getNodeProps)), /*#__PURE__*/_react.default.createElement("div", {
        className: classnames('checkContent', checkClassName)
      }, checkable !== undefined && renderCheckExtra ? renderCheckExtra(this.getExtraData()) : null)), /*#__PURE__*/_react.default.createElement("div", {
