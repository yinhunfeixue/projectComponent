  ...
  _createClass(FormUtil, null, [{
      ...
      for (var i = 0; i < formItemList.length; i++) {
        ...
        if (item.content) {
          ...
          if (item.contentIsFormItem) {
            formItem = /*#__PURE__*/_react.default.cloneElement(item.content, Object.assign(props, item.content.props));
          } else {
            formItem = /*#__PURE__*/_react.default.createElement(_FormItem.default, Object.assign({}, props), item.content);
          }
        } // 创建col
    ...
    value: function renderInlinFormItems(formItemList) {
      ...
      return formItemList.map(function (item, index) {
        return /*#__PURE__*/_react.default.createElement(_FormItem.default, Object.assign({
          key: index,
          label: item.label,
          name: item.name,
          rules: item.rules
