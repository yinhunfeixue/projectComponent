...
var PhoneFormItem = /*#__PURE__*/function (_Component) {
  _inherits(PhoneFormItem, _Component);

  var _super = _createSuper(PhoneFormItem);

  function PhoneFormItem() {
    var _this;

    _classCallCheck(this, PhoneFormItem);

    _this = _super.apply(this, arguments);

    _this.getPhone = function (type) {
      var phone = _FormRegExp.default.MOBILE;

      switch (type) {
        case 1:
          phone = _FormRegExp.default.MOBILE;
          break;

        case 2:
          phone = _FormRegExp.default.PHONE;
          break;
  ...
  return PhoneFormItem;
}(_react.Component);

var _default = PhoneFormItem;
