...
var Curd = /*#__PURE__*/function (_Component) {
  ...
  function Curd(props) {
    ...
    _this.defaultRenderExtra = function (extraData) {
      ...
      return /*#__PURE__*/React.createElement(React.Fragment, null, !disabledCreate && renderCreater && /*#__PURE__*/React.createElement("span", {
        onClick: function onClick() {
          _this.showCreate();
        }
      }, renderCreateElement ? renderCreateElement() : /*#__PURE__*/React.createElement(_Button, {
        type: "primary",
        icon: /*#__PURE__*/React.createElement(EditOutlined, null)
      }, "\u65B0\u5EFA")), _this._batchDeleteEnable && /*#__PURE__*/React.createElement(ConfirmButton, {
        onConfirm: function onConfirm() {
          _this.remove(selectedRowKeys);
        },
        getElement: function getElement(loading) {
          return renderBatchDeleteElement ? renderBatchDeleteElement() : /*#__PURE__*/React.createElement(_Button, {
    ...
    _this.defaultRenderEditColumns = function (record, params) {
      ...
      return /*#__PURE__*/React.createElement(React.Fragment, null, showDelete && /*#__PURE__*/React.createElement(ConfirmButton, {
        onConfirm: function onConfirm() {
          _this.remove([_this.getRecordKey(record)]);
        },
        getElement: function getElement(loading) {
          var loadingDelete = _this.state.deletingKeyList;
          return renderDeleteElement ? renderDeleteElement() : /*#__PURE__*/React.createElement(_Tooltip, {
            title: "\u5220\u9664"
      ...
      }), showEdit && /*#__PURE__*/React.createElement("span", {
        onClick: function onClick() {
          return _this.edit(record);
        }
      }, renderEditElement ? renderEditElement() : /*#__PURE__*/React.createElement(_Tooltip, {
        title: "\u7F16\u8F91"
      }, /*#__PURE__*/React.createElement(_Button, {
        icon: /*#__PURE__*/React.createElement(EditOutlined, null),
        type: "link"
      }))), showPreview && (renderEditPreviewElement ? renderEditPreviewElement() : /*#__PURE__*/React.createElement("span", {
        onClick: function onClick() {
  ...
  _createClass(Curd, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement(SearchTable, {
        columns: useColumns,
        ...
        renderExtra: function renderExtra(extraData) {
          ...
          return /*#__PURE__*/React.createElement(React.Fragment, null, searchItem && /*#__PURE__*/React.createElement(SearchForm, Object.assign({}, searchFormProps, {
